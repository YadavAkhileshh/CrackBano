        ...
        <>
            <div role="status" className="animate-pulse space-y-4 max-w-3xl">
                ...
                <div className="space-y-2">
                    <div className="h-3 bg-gray-200 rounded dark:bg-gray-700 w-full">
                    </div>
                 ...
                 <div className="bg-gray-100 dark:bg-gray-700 rounded p-4 space-y-2"><div className="h-2.5 bg-gray-300 rounded w-3/4"></div>
            ...
            <div className="space-y-2"> <div className="h-3 bg-gray-200 rounded darl:bg-gray-700 w-full"></div>
